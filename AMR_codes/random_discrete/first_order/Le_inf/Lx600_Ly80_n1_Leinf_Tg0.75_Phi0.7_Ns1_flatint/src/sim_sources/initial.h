...
const double 		dt = 0.0002;				//time step, follows stability criterion dt<dx^2/4D

//Model paramters
const double 		Tig = .75;
const double 		Le =  10000000;				// Le ->inf regardless of this number
const double 		aux_Tig = Tig/(1.-Tig);
const double 		ovLe = 0.;
const double 		A = aux_Tig ;
