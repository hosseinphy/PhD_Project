...
const double 		pad_Amp = 3.;				//Amplitude of initial adaption, pad_Amp > Amp 
const int 		flag=1; 				// 0: noisy morphological perturbation, 1: cos(2pi/lambda) morphological perturbation
const int 		flag_readFile=1;			// 1: read the initial cooordinates from the file (only for random discrete case)
...
const double 		ovLe = 0.; //Le->inf			//1./Le;
...
const double 		AdaptThresh = .01;			// adaption criteria threshold
