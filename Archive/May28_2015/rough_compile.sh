...
#then manipulate them in input file  and script file. complie them and give you a chance 
 ...
 read choice
  ...
  if  [ "$choice" == "copy" ]; then
     ...
     #  read number
        ...
        DR="/gs/scratch/hophy/Simulation_results/rough_results"
        ...
        for i in {1..10} 
           do
             i=`echo $i -1 | bc`
               ...
               cp  -r /home/hophy/roughening/serial_higgins_rough \
                     -- /gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"
         done
  ...
  # number1=`echo $number -1 |bc`
   for i in {1..9} 
     do
     mv  /gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"/input0.in \
                -- /gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"/input"$i".in
   done
 ...
 # incl=0.05
   ...
   for i in {1..10} 
    do
      ...
      FILES=/gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"/*
      ...
      for f in $FILES 
        do
         if [[ "$f" != *\.* ]] 
           ...
           sed -i "s/serial_higgins_rough/serial_higgins_rough_"$i"/g"  $f
           sed -i "s/input0/input"$i"/g"  $f         
         fi
      done

      cd /gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"
        ...
        echo "Deleting from file "$var1"_"$var2"_"$var3"_"$var4"_"$var5" "
         ...
         for i in {1..10} 
           do
            ...
            rm -r  /gs/scratch/hophy/Simulation_results/rough_results/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/serial_higgins_rough_"$i"
         done
