...
clear
 ...
 var0=$choice
        ...
        for i in {1..8} 
           do
             i=`echo $i -1 | bc`
               ...
               cp  -r /home/hophy/FINAL_CODE/parallel/2d/Oxd_model \
                     -- /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"
   ...
   for i in {1..7} 
     do
      mv  /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"/parallel_input0.in\
                -- /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"/parallel_input"$i".in
   done
  ...
  mult=40000000
   ...
   for i in {1..8} 
    do
      i=`echo $i -1 | bc`
      #t=0
      FILES=/gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"/*
  ...
  for i in {1..8} 
   do
    ...
    for f in $FILES 
      ...
      cd /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"
         ...
         echo "Deleting from file "$var1"_"$var2"_"$var3"_"$var4"_"$var5"_"$var6" "
          ...
          for i in {1..8} 
            do
             ...
             rm -r /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/2dparallel_"$var0"_"$i"
