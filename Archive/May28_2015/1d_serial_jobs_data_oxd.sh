         ...
         for f in $FILES
           ...
           #  echo "Copying into Continuum folder is in progress ..."
              ...
              for i in {1..20} 
               do
                i=`echo $i -1 | bc`
                FILES2=/gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/1dserial_"$var0"_"$i"/*    
                ...
                for g in $FILES2 
                 do
                  ...
                  # cp  $g   /gs/scratch/hophy/DATA_ANALYSIS/1d_serial/"$var0"_model/10000_0_0.001_0.125_1_300      
                   cp  $g   /gs/scratch/hophy/DATA_ANALYSIS/1d_serial/"$var0"/10000_0_0.001_0.25_1_300      
