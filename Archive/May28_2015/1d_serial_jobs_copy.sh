...
clear
 ...
 var0=$choice
        ...
        for i in {1..200} 
           do
             i=`echo $i -1 | bc`
               ...
               cp  -r /home/hophy/FINAL_CODE/serial/1d/Kint_Oxd_model \
                     -- /gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"
   ...
   for i in {1..199} 
     do
     mv  /gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"/input0.in \
                -- /gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"/input"$i".in
   done
  ...
  mult=40000000
   ...
   for i in {1..200} 
    do
      i=`echo $i -1 | bc`
      #t=0
      FILES=/gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"/*
  ...
  for i in {1..200} 
   do
    ...
    for f in $FILES 
      ...
      cd /gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"
         ...
         echo "Deleting from file "$var1"_"$var2"_"$var3"_"$var4"_"$var5" "
          ...
          for i in {1..200} 
            do
             ...
             rm -r /gs/scratch/hophy/Simulation_results/1d_serial_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/1dserial_"$var0"_"$i"
