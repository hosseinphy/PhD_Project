        ...
        ###   do
           ...
           #  echo "Copying into Continuum folder is in progress ..."
            ...
            ##   do
               ...
               # cp /gs/scratch/hophy/Simulation_results/1d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5""_""$var6"/1dparallel_"$var0"_"$i"/"$var7""_""$vardeltx""_""$p""$var9"    /gs/scratch/hophy/DATA_ANALYSIS/1d_parallel/oxd_continuum/ 120000_0_0.001_1_1_300_"$ignition"

                cp /gs/scratch/hophy/Simulation_results/1d_parallel_oxd_continuum/120000_0_0.001_1_1_300_0.8925/"$var7""$p""$var9"    /gs/scratch/hophy/DATA_ANALYSIS/1d_parallel/oxd_continuum/120000_0_0.001_1_1_300_"$ignition"
