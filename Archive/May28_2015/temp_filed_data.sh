                ...
                for v in {600..800} 
                 do
                  v=`echo $v | bc`
                   ...
                   cp /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/movie/"$var6""$v""$var9"    /gs/scratch/hophy/DATA_ANALYSIS/movie/ 


#                   cp /gs/scratch/hophy/Simulation_results/2d_parallel_"$var0"/"$var1""_""$var2""_""$var3""_""$var4""_""$var5"/2dparallel_"$var0"_"$i"/"$var6""$i""_""$v""_""$vardelt""_""$tnut""$var9"    /gs/scratch/hophy/DATA_ANALYSIS/refined_results_36000_1024/ 
...
#other choices 
       ...
       echo "Delleting from Continuum folder is in progress ..."
           ...
           FILES=/gs/scratch/hophy/DATA_ANALYSIS/movie/*
